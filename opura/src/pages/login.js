      ...
      <div className="h-screen flex flex-col md:flex-row bg-auto bg-no-repeat md:overflow-hidden">
        ...
        <div className="relative md:h-screen md:w-2/3 h-[70vh] md:order-2 order-1 p-3">
          <div className="absolute bottom-0 right-0 p-8">
            <img src="/midia/logotipo-vertical.svg" alt="Logotipo Vertical" className="md:h-[340px] h-[180px]" />
          </div>
          
          <img className="w-full h-[100%] object-cover" src="/midia/imagem.webp" alt="imagem de olá" />
        </div>
      </div>
    </>
  );
